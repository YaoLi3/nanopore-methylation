...
def get_label_segment(fast5_fn, basecall_group, basecall_subgroup):
    ...
    try:
        ...
        segment_data = np.array(
         list(zip(segment_means, segment_stdv, segment_starts, segment_lengths, segment_kmer, segment_move, segment_cstart, segment_clength)),
...
if __name__ == '__main__':
    fast5_fn = "data/PLSP61583_20160920_FNFAB390088_MN17048_sequencing_run_Hum_94_62579_ch268_read765_strand.fast5"
